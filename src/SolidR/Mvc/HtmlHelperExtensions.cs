...
namespace SolidR.Mvc
{
    public static class HtmlHelperExtensions
    {
        ...
        {
            // TODO: Get from current nested container
            //var library = IoC App.Container.ParentScope.CurrentNestedContainer.GetInstance<HtmlConventionLibrary>();
            var library = App.Container.GetInstance<HtmlConventionLibrary>();
            return ElementGenerator<T>.For(library, t => App.Container.GetInstance(t), model);
        }
    }
}
